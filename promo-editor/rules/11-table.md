...
- **⚠️ 수평 라인 전용 스타일** — 세로줄(border-left/right) 금지. 외곽 라인(border-top, border 단축) 도 금지. 오직 `border-bottom` 으로만 행을 구분.
...
- **⚠️ thead 없는 테이블도 border-top 추가 금지** — 외곽 라인 정책상 상단 라인 없음. 헤더 bg 가 가시성 담당.
